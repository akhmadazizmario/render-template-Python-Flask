...
(function ($) {
  ...
  setTimeout(function () {
    if (window.___browserSync___ === undefined && Number(localStorage.getItem('AdminLTE:Demo:MessageShowed')) < Date.now()) {
      ...
      alert('Anda Sedang menjalankan aplikasi !')
    }
  }, 1000)
  ...
  $container.append(
    '<h5>CUSTOM TEMPLATE ADMIN</h5><hr class="mb-2"/>'
  )
  ...
  var $dark_mode_container = $('<div />', { class: 'mb-4' }).append($dark_mode_checkbox).append('<span>Mode Malam</span>')
  ...
  $container.append('<h6> Warna Navbar/atas </h6>')
  ...
  $container.append('<h6>Warna huruf nama profil</h6>')
  ...
  $container.append('<h6>Sidebar mode malam</h6>')
  ...
  $container.append('<h6>sidebar mode putih</h6>')
  ...
  $container.append('<h6>warna tampilan logo</h6>')
